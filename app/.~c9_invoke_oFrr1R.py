...
from .models import Employee,Department, Function, EmployeeHistory, Benefit, MenuItem, MenuCategory, News, NewsCategory, PromotionDrinkMD, HealthDrinkMD, AlcoholicBeveragesMD, Food, Foodsnack, FoodConfectionery
...
class DrinksPageView(BaseView):
    default_view = 'PromotionDrink'
    
    @expose('/PromotionDrink/')
    def PromotionDrink(self):
        param1 = 'Promotion Drink'
        self.update_redirect()
        return self.render_template('news.html', param1 = param1)
    
    @expose('/HealthDrink/')
    def HealthDrink(self):
        param1 = 'Health Drink'
        self.update_redirect()
        return self.render_template('news.html', param1 = param1)     
        
    @expose('/AlcoholicBeverages/')
    def AlcoholicBeverages(self):
        param1 = 'Alcoholic Beverages'
        self.update_redirect()
        return self.render_template('news.html', param1 = param1)
